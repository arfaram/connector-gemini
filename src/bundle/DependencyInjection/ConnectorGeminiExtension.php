...
final class ConnectorGeminiExtension extends Extension implements PrependExtensionInterface
{
    public const string EXTENSION_NAME = 'ibexa_connector_gemini';
    ...
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        foreach ($mergedConfig as $actionType => $actionTypeConfig) {
            foreach ($actionTypeConfig as $key => $value) {
                $container->setParameter(sprintf('ibexa.connector_gemini.%s.%s', $actionType, $key), $value);
            }
        }
