...
namespace ConnectorGeminiBundle\Form\Type;

use Ibexa\Bundle\ConnectorAi\Form\Data\ActionConfiguration\AbstractActionConfigurationData;
...
/**
 * @extends AbstractType<AbstractActionConfigurationData>
 */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addEventListener(
            ...
            function (FormEvent $event) use ($options): void {
                ...
                $form->add('max_tokens', IntegerType::class, [
                    'disabled' => $options['translation_mode'],
